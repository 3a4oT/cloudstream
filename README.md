...
## 👨🏻‍🔧 Як завантажити?
Можна [завантажити APK файл](https://github.com/3a4oT/cloudstream/releases/download/4.6.1/cloudstream-UKR-4.6.1-aligned.apk) на флешку і встановити прямо на телевізор (👀 ВАЖЛИВО 👀, щоб у налаштуваннях телевізора було дозволено встановлювати додатки з 'невідомих джерел'. Шукай в налаштуваннях Android TV `Налаштування -> Параметри пристрою -> Безпека й обмеження -> Невідомі джерела`).
